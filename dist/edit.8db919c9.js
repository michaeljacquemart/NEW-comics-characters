...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"ts/requestsAPI.ts":[function(require,module,exports) {
"use strict";
...
var urlAPI = "https://character-database.becode.xyz/characters";
...
var getOneCharacter = function getOneCharacter(id) {
  return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
exports.getOneCharacter = getOneCharacter; // EDIT

var putCharacter = function putCharacter(data) {
  return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , axios_1.default.put(urlAPI + "/" + data.id, data)];
...
exports.putCharacter = putCharacter; // CREATE

var postCharacter = function postCharacter(data) {
  return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , axios_1.default.post("" + urlAPI, data)];
...
exports.postCharacter = postCharacter; // DELETE

var deleteCharacter = function deleteCharacter(id) {
  return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , axios_1.default.delete(urlAPI + "/" + id)];
...
},{"axios":"../node_modules/axios/index.js"}],"ts/edit.ts":[function(require,module,exports) {
"use strict";
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  case 0:
                    ...
                    return [4
                    /*yield*/
                    , requestsAPI_1.putCharacter(data)];
...
},{"./requestsAPI":"ts/requestsAPI.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/edit.ts"], null)
//# sourceMappingURL=/edit.8db919c9.js.map